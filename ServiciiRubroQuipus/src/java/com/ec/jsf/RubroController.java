...
import com.ec.jsf.util.JsfUtil;
import com.ec.jsf.util.JsfUtil.PersistAction;
import com.ec.servicios.RubroFacade;
...
public class RubroController implements Serializable {
    ...
    @EJB
    private com.ec.servicios.RubroFacade ejbFacade;
    ...
    public static class RubroControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Rubro) {
                ...
                return getStringKey(o.getIdrubroalcanzado());
            } else {
